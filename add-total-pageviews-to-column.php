<?php
/**
 * Add total pageviews to the post/page list table column header.
 *
 * Queries all filtered posts in the current admin list view and sums
 * the `burst_total_pageviews_count` postmeta to display in the column title.
 *
 * @param array<string, string> $columns The current admin columns.
 *
 * @return array<string, string> Modified columns with pageview total in the header.
 */
function custom_admin_pageviews_column_title( array $columns ): array {
    global $wpdb, $typenow;
